      ...
      <div className='px-6 py-6 bg-white rounded'>
        <div className="flex flex-wrap justify-between lg:justify-start md:justify-center">
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Job Number:</strong>
              <span className="px-2">{job.id}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Job Name:</strong>
              <span className="px-2">{job.name}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Job Description:</strong>
              <span className="px-2">{job.description}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Delivery Date:</strong>
              <span className="px-2">{job.deliver_date}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Client Name:</strong>
              <span className="px-2">{job.client_name}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Account Of:</strong>
              <span className="px-2">{job.account_of}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Costing Required:</strong>
              <span className="px-2">{job.costing_req ? 'Yes' : 'No'}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Created Date:</strong>
              <span className="px-2">{job.created_at}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Inserted by:</strong>
              <span className="px-2">{job.created_by}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Modified by:</strong>
              <span className="px-2">{job.updated_by}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Order In Pieces:</strong>
              <span className="px-2">{job.order_in_pieces}</span>
            </p>
          </div>
          <div className='lg:w-1/3 md:w-1/2 w-full'>
            <p className="text-sm w-full text-gray-600 p-2"><strong className="text-blue-600">Order In Sheet:</strong>
